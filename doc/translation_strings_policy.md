...
This document provides guidelines for internationalization of the Nobilitas Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `nobilitas_en.ts` remains unchanged.
