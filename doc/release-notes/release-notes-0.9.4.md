Nobilitas Core version 0.9.4 is now available from:

  https://nobilitas.org/bin/0.9.4/
...
this update is incompatible with the Nobilitas system and could lead to consensus
forks.

Nobilitas Core released binaries from https://nobilitas.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~nobilitas/+archive/ubuntu/nobilitas
- A third-party or self-compiled Nobilitas Core

upgrade to Nobilitas Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
