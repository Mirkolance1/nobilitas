Nobilitas Core version 0.13.2 is now available from:

  <https://nobilitas.org/bin/nobilitas-core-0.13.2/>
...
- #8908 `4a974b2` Update nobilitas-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow nobilitas-tx to create v2 transactions (btcdrak)
