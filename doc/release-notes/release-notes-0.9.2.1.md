Nobilitas Core version 0.9.2.1 is now available from:

  https://nobilitas.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 NOBI to 0.01 NOBI
...
- Fix "Start nobilitas on system login"
