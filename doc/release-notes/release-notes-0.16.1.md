Nobilitas Core version 0.16.1 is now available from:

  <https://nobilitascore.org/bin/nobilitas-core-0.16.1/>
...
- #12843 `df38b13` Test starting nobilitasd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure nobilitasd processes are cleaned up when tests end (sdaftuar)
