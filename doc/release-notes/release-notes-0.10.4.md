Nobilitas Core version 0.10.4 is now available from:

  <https://nobilitas.org/bin/nobilitas-core-0.10.4/>
...
- #6953 `43c2789` Split nobilitas-tx into its own package
- #6953 `dfe0d4d` Include nobilitas-tx binary on Debian/Ubuntu
