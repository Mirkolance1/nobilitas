Nobilitas Core version 0.10.3 is now available from:

  <https://nobilitas.org/bin/nobilitas-core-0.10.3/>
...
(see https://github.com/nobilitas/nobilitas/pull/6793, as well as the 0.11.0
