Nobilitas-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/nobilitas/files/Nobilitas/nobilitas-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Nobilitas
...
New/changed settings (command-line or nobilitas.conf file)
--------------------------------------------------------
