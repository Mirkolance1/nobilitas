Nobilitas Core version *0.14.3* is now available from:

  <https://nobilitas.org/bin/nobilitas-core-0.14.3/>
...
- #10451 `3612219` contrib/init/nobilitasd.openrcconf: Don't disable wallet by default (Luke Dashjr)
