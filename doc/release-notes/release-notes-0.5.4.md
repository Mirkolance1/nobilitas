Nobilitas version 0.5.4 is now available for download at:
http://sourceforge.net/projects/nobilitas/files/Nobilitas/nobilitas-0.5.4/
...
http://gitorious.org/nobilitas/nobilitasd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Nobilitas-Qt notifications under Growl 1.3.
Increase required age of Nobilitas-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxNobilitas properly when installing Nobilitas-Qt over it. (Windows)
