...
#ifndef NOBILITAS_WALLET_WALLET_H
#define NOBILITAS_WALLET_WALLET_H
...
enum WalletFlags : uint64_t {
    ...
    //! nobilitas from opening the wallet, thinking it was newly created, and
 ...
 * change.
 *
 * The Nobilitas Core wallet was originally a collection of unrelated private
...
public:
     ...
     * on this nobilitas node, and set to 0 for transactions that were created
...
#endif // NOBILITAS_WALLET_WALLET_H
