...
#ifndef NOBILITAS_SCRIPT_STANDARD_H
#define NOBILITAS_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a nobilitas address
 */
...
/**
 * Generate a Nobilitas scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // NOBILITAS_SCRIPT_STANDARD_H
