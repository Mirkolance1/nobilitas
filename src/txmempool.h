...
#ifndef NOBILITAS_TXMEMPOOL_H
#define NOBILITAS_TXMEMPOOL_H
...
public:
     ...
     * https://github.com/nobilitas/nobilitas/pull/14193 will fix it. No known code
     * in nobilitas currently depends on second guarantee, but it is important to
