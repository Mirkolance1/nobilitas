...
#ifndef NOBILITAS_TEST_SCRIPTNUM10_H
#define NOBILITAS_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Nobilitas Core 0.10.0, for cross-comparison.
 */
public:
