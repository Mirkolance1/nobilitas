...
static void SetupNobilitasTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " nobilitas-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  nobilitas-tx [options] <hex-tx> [commands]  Update hex-encoded nobilitas transaction\n" +
            "or:     nobilitas-tx [options] -create [commands]   Create hex-encoded nobilitas transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded nobilitas transaction
