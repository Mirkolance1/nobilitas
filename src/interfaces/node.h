...
#ifndef NOBILITAS_INTERFACES_NODE_H
#define NOBILITAS_INTERFACES_NODE_H
...
//! Top-level interface for a nobilitas node (nobilitasd process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // NOBILITAS_INTERFACES_NODE_H
