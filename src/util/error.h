// Copyright (c) 2010-2018 The Nobilitas Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef NOBILITAS_UTIL_ERROR_H
#define NOBILITAS_UTIL_ERROR_H
 ...
 *
 * Error types defined here can be used in different parts of the nobilitas
