...
#ifndef NOBILITAS_QT_SPLASHSCREEN_H
#define NOBILITAS_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. Nobilitas Core initialization
...
#endif // NOBILITAS_QT_SPLASHSCREEN_H
