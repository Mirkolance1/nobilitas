    ...
    platformStyle(_platformStyle)
{
    ...
    // normal nobilitas address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying nobilitas address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &NobilitasAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
