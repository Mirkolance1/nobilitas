...
#include <config/nobilitas-config.h> /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatNobilitasURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + NobilitasUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatNobilitasURI(info));
}
