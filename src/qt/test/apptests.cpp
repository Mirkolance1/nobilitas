...
//! Entry point for NobilitasApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &NobilitasApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for NobilitasGUI tests.
void AppTests::guiTests(NobilitasGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &NobilitasGUI::consoleShown, this, &AppTests::consoleTests);
