    ...
    mapper(nullptr)
{
    ...
    ui->nobilitasAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->nobilitasAtStartup);
    ...
    ui->nobilitasAtStartup->setToolTip(ui->nobilitasAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->nobilitasAtStartup->setText(ui->nobilitasAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openNobilitasConfButton->setToolTip(ui->openNobilitasConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new NobilitasUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->nobilitasAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openNobilitasConfButton_clicked()
{
