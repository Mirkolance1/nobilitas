...
#ifndef NOBILITAS_QT_NOBILITASUNITS_H
#define NOBILITAS_QT_NOBILITASUNITS_H
...
/** Nobilitas unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class NobilitasUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit NobilitasUnits(QObject *parent);

    /** Nobilitas units.
      @note Source: https://en.nobilitas.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        NOBI,
...
typedef NobilitasUnits::Unit NobilitasUnit;

#endif // NOBILITAS_QT_NOBILITASUNITS_H
