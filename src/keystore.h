...
#ifndef NOBILITAS_KEYSTORE_H
#define NOBILITAS_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/nobilitas/bips/blob/master/bip-0013.mediawiki
