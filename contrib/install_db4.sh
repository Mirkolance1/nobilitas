...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the nobilitas repository."
  exit 1
fi
...
# See https://github.com/nobilitas/nobilitas/issues/16064
...
echo
echo 'When compiling nobilitasd, run `./configure` in the following way:'
echo
