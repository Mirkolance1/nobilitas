...
By default, nobilitasd will dump mempool on shutdown and
...
class MempoolPersistTest(NobilitasTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent nobilitasd from writing mempool.dat to disk. Verify that `savemempool` fails")
