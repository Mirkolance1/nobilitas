...
"""Verify that starting nobilitas with -h works as expected."""

from test_framework.test_framework import NobilitasTestFramework
from test_framework.util import assert_equal

class HelpTest(NobilitasTestFramework):
    ...
    def run_test(self):
        self.log.info("Start nobilitas with -h for help text")
        ...
        self.log.info("Start nobilitas with -version for version information")
        ...
        self.log.info("Start nobilitasd with -fakearg to make sure it does not start")
