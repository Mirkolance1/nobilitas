#!/usr/bin/env python3
# Copyright (c) 2016-2019 The Nobilitas Core developers
...
# TestP2PConn: A peer we use to send messages to nobilitasd, and store responses.
...
class CompactBlocksTest(NobilitasTestFramework):
    ...
    # This test actually causes nobilitasd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that nobilitasd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for nobilitasd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        version = test_node.cmpct_version
        node = self.nodes[0]
        # nobilitasd will not send blocktxn responses for blocks whose height is
